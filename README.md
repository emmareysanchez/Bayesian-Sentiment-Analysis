...
Luego ejecutar el modelo bnn_moe_hetero desde este archivo distinto:

```bash
python scripts/train_hetero_transfer.py --transfer-seed 42 --train-seed 42 --epochs 30 --lr 1e-4
```
...
python scripts/05_business_analysis.py \
  --cost-fp 1.0 --cost-fn 1.0 --cost-review 0.4
```
